...
const WORKOUT_ICONS = {
  ...
  // Dancer: no Tabler dance icon, so this one is drawn here.
  Dance: tablerIcon(["M13 4m-1.5 0a1.5 1.5 0 1 0 3 0a1.5 1.5 0 1 0 -3 0", "M12 8l-1 5.5", "M12 9l5 -3.5", "M11.8 9.5l-4.3 1.8l-1.5 -2.3", "M11 13.5l3.5 2.5l1 4.5", "M11 13.5l-2.5 3l-3 2"]),
