...
const GroupHome = ({groups,currentIdentity,currentEmail,onOpenProfile,onOpenGroup,onCreateGroup,onJoinGroup,creating,autoOpenCreate=false,onAutoOpenHandled,suppressIntro=false}) => {
