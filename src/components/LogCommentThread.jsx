...
function LogCommentThread({ open, groupId, log, currentUserId, currentUserName, onClose, onCommentCountChange }) {
  ...
  return React.createElement('div', {
    onClick: onClose,
    style: { position: "fixed", inset: 0, zIndex: 360, display: "flex", alignItems: "flex-start", justifyContent: "center", paddingTop: "calc(env(safe-area-inset-top) + 50px)", background: "rgba(0,0,0,.58)" }
  },
