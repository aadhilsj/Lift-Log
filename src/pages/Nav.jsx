...
const StreamIconButton = ({ onOpenStream, unreadCount = 0, size }) => {
  ...
  return React.createElement('button', {
    ...
    hasUnread && React.createElement('span', {
      style: { position: "absolute", top: -4, right: -5, minWidth: 12, height: 12, padding: "0 2.5px", borderRadius: 999, background: "#4ECDC4", color: "#04110e", fontFamily: "'Outfit', sans-serif", fontSize: 8, fontWeight: 700, lineHeight: 1, display: "inline-flex", alignItems: "center", justifyContent: "center", boxShadow: "0 0 0 1.5px var(--s1)" }
