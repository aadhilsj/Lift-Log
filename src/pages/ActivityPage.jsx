...
const ActivityPage = ({group,currentUser,currentUserId,onLogMutation,clockTick,reactionOverrides,setReactionOverrides,commentCountOverrides,onOpenLogComments}) => {
  ...
  return React.createElement('div',{style:wrapStyle},
    React.createElement(ActivityFeed,{group,currentUser,currentUserId,onReact:handleReaction,onFlag:handleFlag,onRespond:handleRespond,onReview:handleReview,clockTick,reactionOverrides,setReactionOverrides,commentCountOverrides,onOpenLogComments})
  );
};
