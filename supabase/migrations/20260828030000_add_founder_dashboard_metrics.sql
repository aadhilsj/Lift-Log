...
--
-- This migration intentionally makes no change to existing product records.
-- It adds private, retention-limited activity data and service-role-only
-- aggregate functions for the founder dashboard.
