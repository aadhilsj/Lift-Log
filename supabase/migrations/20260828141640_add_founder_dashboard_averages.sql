-- Adds aggregate-only trailing averages to the existing private founder dashboard.
-- Rollback: restore the prior read_ante_core_founder_dashboard function definition
-- from 20260828030000_add_founder_dashboard_metrics.sql. No table data changes.
